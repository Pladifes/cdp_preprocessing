...
def get_df_year_clean_2019(path_raw_data):
    """
    ...
    df_years = pd.read_excel(path_raw_data + "CDP_CC_emissions data_2019.xlsx", sheet_name="C0.2")
...
if __name__ == "__main__":
    ...
    df = get_df_year_clean_2019(path_raw_data)
    df.to_excel("temp_2019.xlsx")
