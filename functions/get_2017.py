...
def get_df_year_clean_2017(path_raw_data):
    """
    Creates the clean datset for year 2017
    """
    year = 2017
    # Load useful sheets
    ...
    df_clean = df_clean[df_clean.unique_id != "47737_2016"]
...
if __name__ == "__main__":
    ...
    df = get_df_year_clean_2017(path_raw_data)
    df.to_excel("temp_2017.xlsx")
